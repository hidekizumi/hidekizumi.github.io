...
思い出といえば、やっぱりゼミ選びでしたね。とりあえずこれからの2年を左右するし。デーサのゼミは、①超エリートビジネスデータサイエンス系、②普通のビジネスデータサイエンス系、③めっちゃ統計学ぼうぜ系、④めっちゃ情報学学ぼうぜ系、⑤神経科学系に分かれると思います（偏見）。僕は⑤に進みまちた。ちなみに研究サボってこれ書いてますすみません🙇‍♂️。

ゼミ見学については、たしか夏休み前からスタートしてて、とにかく興味あるところは全部聞きに行った方が良いと思います。あと、友達と話したり。夢語ったり他人の夢を聞くのはやっぱ楽しいし、なんかそういうの大事だと思うので。まあ僕は友達いn...。
...
あと、なんというか、多変量解析入門とセットでやれば良いのに、、、と思う授業でした。高校の頃って、同じ教科が1週間に2回や3回あるものってありましたよね？そんな感じで、春学期にこれと多変量解析入門と多変量解析の授業2つあれば良かったのにと思いました。

でもこれ、滋賀大のカリキュラムの流れ（実践的→数学で理論的）が合ってないだけかもしれません。統計学要論と統計数学でも同じことを思いました。異端者なんですね、僕は、、、
...
これはやばい授業でした。まず、講義資料が日本語と英語のバイリンガルです。で、進行もちょっと格式高くて僕の脳ではついていけなかったし分かりにくかったです。あとPythonじゃなくてRを使います。

そんな時に役に立ったのがこちらの二冊。一つは、[経済・ファイナンスデータの計量時系列分析](https://www.amazon.co.jp/経済・ファイナンスデータの計量時系列分析-統計ライブラリー-沖本-竜義/dp/4254127928)です。これは定期テストでも役立ちました。一般的には沖本本と言われていて、分かりやすい理論的な本です。しかもTJOさんの愛書ということでちょっとでも調べればTJOさんの記事がいーーーっぱい出てきます。式変形とかわからなくても、調べればでてくるのでそういうところもいいと思います。もう満点だしみんなで輪読したいくらい好きな本です。これもご要望があれば貸します（あげないけど）。
...
まず、2月24日まで色々あって全く勉強していませんでした。なので、25, 26, 27日の3日間しか勉強時間がなく、超短期型の勉強が必要となりました。まず積んでおいた問題集vol. 7のTEST 1を解いて、集中力なさすぎてリーディング解き終わらず笑。これはやばいと思いました。それで、スタディサプリTOEICの1週間無料のやつを始めてただひたすら解いて、解法のポイントを見つけたらノートに書いて、分からない単語はQuizletで管理して、25、26日を過ごし、27日に問題集vol. 7のTEST 2を解いて、L: 97, R:93でした。

が、本番はまさかの席一番後ろの列で、リスニングまあまあ終わりました。でもLは495で満点だったので、これ多分得点調整ありましたね。満点のはずないです。あのボワボワの音響で満点はありえないです。前日も97点でしたし。

ということで、3日で900超えます！なんてことが言いたいわけではなく、実は1年中洋書の輪読会に参加していたのが効いたのではと考察しております。毎週英語やってたからね。ずっと英語に触れないのと毎週触れるのはやっぱり違います。毎日は、別に英語で食べていくわけではないので必要ないとは思うけど、毎週質のいい英文の輪読をするのはTOEICには効果的だと思います。
...
これまた全然授業関係ないけど、3月10, 11日に受験して、午前9割、午後9割で多分合格したので、勉強法などをまとめます。

まず、3月1日に申し込みをして勉強を始めました。でもなんか全然日程が空いてなくて、10日後の試験になりました。今後受ける人は受けること決めたらすぐに予約した方がいいです。

で、3月1日から4日くらいまではなんかモンテカルロ統計計算を買っちゃっててそっち面白くて読んでました笑。3月5日から「やばいんじゃね」となって、過去問解きます。全くわかりません。えーん。急いでテクノロジ分野から勉強始めて、[参考書](https://www.amazon.co.jp/令和03年-イメージ-クレバー方式でよくわかる-栢木先生の基本情報技術者教室-情報処理技術者試験/dp/4297117169/ref=tmm_pap_swatch_0?_encoding=UTF8&qid=&sr=)の1章分を1-2hsでインプットして、過去問道場でその分野に絞って3hsくらいで80-100問くらい解いて、を経営・法務・データベースの章以外でこれをしました。で、経営・法務・データベースは特別には勉強してません。そのあと3回分の過去問を解いて、午前は90点でした。

午後はやばかったです。でもあれは、形式に慣れて、文章の読み方をトレーニングしたら、あとは本番勝負です。どれだけ練習するかより、本番どれくらい頭が冴えてるかの方が重要だと思います。よって、前日はめっちゃ早く寝ました笑。
